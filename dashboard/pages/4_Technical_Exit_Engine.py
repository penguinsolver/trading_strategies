"""
Compare Technical Indicators with Exit Engine - standardized stops and trailing.
"""
import sys
...
def render_exit_engine_page():
    ...
    ">
        <h1 style="margin: 0; font-size: 2rem; font-weight: 700;">📊 Technical + Exit Engine</h1>
        <p style="margin: 0.5rem 0 0 0; opacity: 0.9;">Same 90 TA strategies with standardized stops + trailing</p>
    </div>
